...
Usage:
1. Configure the parameters of simulation using the wind_stat_config.py
...
import pandas as pd
import os
from wind_stat_config import exceptions, modebias, modeplt
from wind_stat_config import cl_iso_h, sin_iso_h                                          # ISO (Hourly)
from wind_stat_config import bc_cl_sim_h, bc_sin_sim_h                                    # BC  (Hourly)
from wind_stat_config import nbc_cl_sim_h, nbc_sin_sim_h                                  # NBC (Hourly)
from wind_stat_config import cl_iso_d, sin_iso_d                                          # ISO (Daily)
from wind_stat_config import bc_cl_sim_d, bc_sin_sim_d                                    # BC (Daily)
from wind_stat_config import nbc_cl_sim_d, nbc_sin_sim_d                                  # NBC (Daily)
from wind_stat_config import cl_iso_m, sin_iso_m                                          # ISO (Monthly)
from wind_stat_config import bc_cl_sim_m, bc_sin_sim_m                                    # BC (Monthly)
from wind_stat_config import nbc_cl_sim_m, nbc_sin_sim_m                                  # NBC (Monthly)
from wind_stat_config import fig_path_folder
from wind_stat_config import asset, beg, end
from wind_stat_config import minpts, stat_min
from wind_stat_config import stats_path_folder                                            # statistical analysis for subgrids
...
# read hourly dataframes needed to perform benchmark analysis (1: BC; 2:NBC)
if modebias==1:
    # read hourly
...
def plot_xy(cl_iso, cl_sim, tf):
    ...
    n_map = {
        'Alegria I': 'Alegria I',
        'Alegria II': 'Alegria II',
        'Cataventos Acaraú I': 'Acaraú I',
        'Cidreira 1': 'Cidreira 1',
        'Conj. Abil I': 'Abil I',
        'Conj. Abil II': 'Abil II',
        'Conj. Acaraú II': 'Acaraú II',
        'Conj. Acauã': 'Acauã',
        'Conj. Afonso Bezerra': 'Afonso Bezerra',
        'Conj. Água Doce': 'Água Doce',
        'Conj. Amazonas': 'Amazonas',
        'Conj. Anemus': 'Anemus',
        'Conj. Araçás': 'Araçás',
        'Conj. Aracati II': 'Aracati II',
        'Conj. Araripe III': 'Araripe III',
        'Conj. Areia Branca': 'Areia Branca',
        'Conj. Arizona': 'Arizona',
        'Conj. Asa Branca': 'Asa Branca',
        'Conj. Atlântica': 'Atlântica',
        'Conj. Aventura': 'Aventura',
        'Conj. Babilônia': 'Babilônia',
        'Conj. Babilônia Sul': 'Babilônia Sul',
        'Conj. Baixa do Feijão': 'B. Feijão',
        'Conj. Bloco Sul': 'Bloco Sul',
        'Conj. Bom Jardim': 'Bom Jardim',
        'Conj. Brisa Potiguar I': 'B. Potiguar I',
        'Conj. Brotas de Macaúbas': 'B. Macaúbas',
        'Conj. BW Guirapá I': 'BW Guirapá I',
        'Conj. BW Guirapá II': 'BW Guirapá II',
        'Conj. Cabeço Preto II': 'C. Preto II',
        'Conj. Cacimbas': 'Cacimbas',
        'Conj. Caetés II': 'Caetés II',
        'Conj. Caetité': 'Caetité',
        'Conj. Caetité 123': 'Caetité 123',
        'Conj. Caetité A': 'Caetité A',
        'Conj. Caju': 'Caju',
        'Conj. Calango 1': 'Calango 1',
        'Conj. Calango 2': 'Calango 2',
        'Conj. Calango 3': 'Calango 3',
        'Conj. Campo dos Ventos': 'C. Ventos',
        'Conj. Campo Formoso': 'C. Formoso',
        'Conj. Campo Largo': 'C. Largo',
        'Conj. Campo Largo 2': 'C. Largo 2',
        'Conj. Canudos I': 'Canudos I',
        'Conj. Carcará II': 'Carcará II',
        'Conj. Carnaúbas': 'Carnaúbas',
        'Conj. Casa Nova': 'Casa Nova',
        'Conj. Chafariz Norte': 'C. Norte',
        'Conj. Chafariz Sul I': 'C. Sul I',
        'Conj. Chafariz Sul II': 'C. Sul II',
        'Conj. Chapada I': 'Chapada I',
        'Conj. Chapada II': 'Chapada II',
        'Conj. Chapada III': 'Chapada III',
        'Conj. Chapadinha': 'Chapadinha',
        'Conj. Cristal': 'Cristal',
        'Conj. Cristalândia': 'Cristalândia',
        'Conj. Cumaru': 'Cumaru',
        'Conj. Curva dos Ventos': 'C. Ventos',
        'Conj. Cutia': 'Cutia',
        'Conj. Delfina': 'Delfina',
        'Conj. Faísa': 'Faísa',
        'Conj. Filgueira': 'Filgueira',
        'Conj. Folha de Serra': 'Folha Serra',
        'Conj. Folha Larga': 'Folha Larga',
        'Conj. Folha Larga Sul': 'F. Larga Sul',
        'Conj. Gameleira': 'Gameleira',
        'Conj. Gentio do Ouro I': 'G. Ouro I',
        'Conj. GPEXPAN': 'GPEXPAN',
        'Conj. Icaraí': 'Icaraí',
        'Conj. Igaporã II': 'Igaporã II',
        'Conj. Itarema V': 'Itarema V',
        'Conj. Jandaia': 'Jandaia',
        'Conj. Jandaíra I': 'Jandaíra I',
        'Conj. Jandaíra III': 'Jandaíra III',
        'Conj. Jerusalém': 'Jerusalém',
        'Conj. Lagoa do Barro I': 'L. do Barro I',
        'Conj. Lagoa do Barro II': 'L. do Barro II',
        'Conj. Lagoa dos Barros': 'L. Barros',
        'Conj. Lagoa dos Ventos': 'L. Ventos',
        'Conj. Laranjeiras': 'Laranjeiras',
        'Conj. Livramento 2': 'Livramento 2',
        'Conj. Macacos': 'Macacos',
        'Conj. Mangue Seco': 'Mangue Seco',
        'Conj. Marmeleiro 2': 'Marmeleiro 2',
        'Conj. Modelo': 'Modelo',
        'Conj. Monte do Ronca': 'Monte Ronca',
        'Conj. Monte Verde': 'Monte Verde',
        'Conj. Morrão': 'Morrão',
        'Conj. Morro do Chapéu Sul': 'Chapéu Sul',
        'Conj. Morro do Chapéu Sul II-A': 'Chapéu II-A',
        'Conj. Morro do Chapéu Sul II-B': 'Chapéu II-B',
        'Conj. Morro dos Ventos': 'M. Ventos',
        'Conj. Morro dos Ventos II': 'M. Ventos II',
        'Conj. Oeste Serido': 'Oeste Serido',
        'Conj. Oitis': 'Oitis',
        'Conj. Olho d\'Água': 'Olho d\'Água',
        'Conj. Papagaios': 'Papagaios',
        'Conj. Paranatama': 'Paranatama',
        'Conj. Paulino Neves': 'Paulino Neves',
        'Conj. Pedra Branca': 'Pedra Branca',
        'Conj. Pedra Cheirosa': 'P. Cheirosa',
        'Conj. Pelourinho': 'Pelourinho',
        'Conj. Pitombeira': 'Pitombeira',
        'Conj. Quina': 'Quina',
        'Conj. Quinta 138 kV': 'Quinta 138 kV',
        'Conj. Quinta 69 kV': 'Quinta 69 kV',
        'Conj. Renascença': 'Renascença',
        'Conj. Renascença V': 'Renascença V',
        'Conj. Riachão': 'Riachão',
        'Conj. Rio do Vento': 'Rio Vento',
        'Conj. Rio do Vento Expansão': 'Rio Vento E',
        'Conj. Santa Clara': 'Santa Clara',
        'Conj. Santa Eugênia': 'Santa Eugênia',
        'Conj. Santa Rosa Mundo Novo': 'S.R.M. Novo',
        'Conj. Santa Rosália': 'Santa Rosália',
        'Conj. Santa Vitória do Palmar': 'S.V. Palmar',
        'Conj. Santo Agostinho': 'S. Agostinho',
        'Conj. Santo Inácio': 'S. Inácio',
        'Conj. São Basílio': 'São Basílio',
        'Conj. São Clemente': 'São Clemente',
        'Conj. São Miguel': 'São Miguel',
        'Conj. São Roque': 'São Roque',
        'Conj. São Vitor': 'São Vitor',
        'Conj. Serra Azul': 'Serra Azul',
        'Conj. Serra da Babilônia': 'S. Babilônia',
        'Conj. Serra de Santana 1 e 2': 'S. Santana 1/2',
        'Conj. Serra de Santana 3': 'S. Santana 3',
        'Conj. Serra do Mel A': 'S. Mel A',
        'Conj. Serra do Mel B': 'S. Mel B',
        'Conj. Serra do Mel II A': 'S. Mel II A',
        'Conj. Serra do Mel II B': 'S. Mel II B',
        'Conj. Serra do Seridó': 'S. do Seridó',
        'Conj. Serrote A': 'Serrote A',
        'Conj. Tacaratu': 'Tacaratu',
        'Conj. Tacaratu II': 'Tacaratu II',
        'Conj. Taíba': 'Taíba',
        'Conj. Tamboril I': 'Tamboril I',
        'Conj. Tamboril II': 'Tamboril II',
        'Conj. Tanque Novo': 'Tanque Novo',
        'Conj. Terra Santa': 'Terra Santa',
        'Conj. Trairí': 'Trairí',
        'Conj. Tucano': 'Tucano',
        'Conj. Umburanas': 'Umburanas',
        'Conj. União dos Ventos': 'U. Ventos',
        'Conj. Ventos da Bahia 2': 'V. Bahia 2',
        'Conj. Ventos da Bahia III': 'V. Bahia III',
        'Conj. Ventos de São Roque A': 'V. S. Roque A',
        'Conj. Ventos de São Vitor': 'V. de S. Vitor',
        'Conj. Ventos do Piauí II': 'V. do Piauí II',
        'Conj. Ventos do Piauí III': 'V. do Piauí III',
        'Conj. Viamão 3': 'Viamão 3',
        'Conjunto Eólico Ourolândia II': 'Ourolândia II',
        'Icaraizinho': 'Icaraizinho',
        'Malhadinha 1': 'Malhadinha 1',
        'Miassaba 3': 'Miassaba 3',
        'Praia Formosa': 'Praia Formosa',
        'Rei dos Ventos 1': 'R. Ventos 1',
        'Rei dos Ventos 3': 'R. Ventos 3',
        'São Fernando 4': 'S. Fernando 4',
        'Xangri-lá': 'Xangri-lá'
    }
    while ielem < nlist:
        ...
        if tf==1:
            figure_name = f"wind_1_hourly_bench_{page}.png"  # Construct the filename
        elif tf==2:
            figure_name = f"wind_1_daily_bench_{page}.png"
        elif tf==3:
            figure_name = f"wind_1_monthly_bench_{page}.png"
...
def plot_xy_comb(sin_iso, sin_sim, tf):
    ...
    if not filtered_df.empty:  # Check if there is data
        ...
        # save the files with higher resolution
        if tf==1:
            figure_name = f"wind_2_hourly_combined.png"  # Construct the filename
        elif tf==2:
            figure_name = f"wind_2_daily_combined.png"
        elif tf==3:
            figure_name = f"wind_2_monthly_combined.png"
        save_path = os.path.join(fig_path_folder, figure_name)  # Combine the directory with the filename
        plt.savefig(save_path, dpi=300)  # Save the figure        
...
def plot_ts(iso, sim, index, col):
    ...
    figure_name = f"wind_3_cl_hourly_{index+1}"  # Construct the filename
    # combined
    if col=='sin':
        figure_name = f"wind_3_combined_hourly_{index+1}"
    # cluster
    save_path = os.path.join(fig_path_folder, figure_name)  # Combine the directory with the filename
    plt.savefig(save_path, dpi=300)  # Save the figure        
    #plt.show()  # Show the current page of plots
...
def plot_ts_2(sin_iso, sin_sim, index, col):
    ...
    figure_name = f"wind_3_cl_hourly_{index + 1}_2.png"  # Construct the filename
    save_path = os.path.join(fig_path_folder, figure_name)  # Combine the directory with the filename
    plt.savefig(save_path, dpi=300)  # Save the figure
...
def boxplot(iso, sim_bc, sim_nbc):
    ...
    # save plot into a file
    figure_name = f"wind_4_boxplot.png"  # Construct the filename
    save_path = os.path.join(fig_path_folder, figure_name)  # Combine the directory with the filename
    plt.savefig(save_path, dpi=300)  # Save the figure
    # plt.show()  # Uncomment if you want to display the figure as well
    plt.close(fig)
...
def boxplot_all(labels, iso, sim1, sim2, sim3, sim4, sim5):
    ...
    y_labels = ['Correlation Coefficient', 'RMSE', 'MBE']
    y_limits = [(0.2,1.0), (0.0,0.8),(-0.7,0.7)]
    ...
    # save plot into a file
    figure_name_png = f"wind_5_boxplot_all.png"  # Construct the filename
    figure_name_pdf = f"wind_5_boxplot_all.pdf"
...
def stats_calc(tf, iso,sim_h1,sim_h2,sim_h3,sim_h4,sim_h5):
    ...
    if countval > stat_min:  # it has at least a minimum amount of datapoints
        ...
        # save csv files
        if tf==1:
            csv_name = f"wind_hourly_stats.csv"  # Construct the filename
        elif tf==2:
            csv_name = f"wind_daily_stats.csv"
        elif tf==3:
            csv_name = f"wind_monthly_stats.csv"
...
if modeplt==5:
    ...
    cl_iso_h_file=os.path.join(script_dir,'data/Wind/benchmark/BC_1/h_cl_iso.csv')
    cl_sim_h1_file=os.path.join(script_dir,'data/Wind/benchmark/NBC/h_cl_sim.csv')
    cl_sim_h2_file=os.path.join(script_dir,'data/Wind/benchmark/BC_1/h_cl_sim.csv')
    cl_sim_h3_file=os.path.join(script_dir,'data/Wind/benchmark/BC_30_C/h_cl_sim.csv')
    cl_sim_h4_file=os.path.join(script_dir,'data/Wind/benchmark/BC_10_C/h_cl_sim.csv')
    cl_sim_h5_file=os.path.join(script_dir,'data/Wind/benchmark/BC_5_C/h_cl_sim.csv')

    cl_iso_h=pd.read_csv(cl_iso_h_file, index_col=0, parse_dates=True).tail(43800)
    nbc_sim_h1=pd.read_csv(cl_sim_h1_file, index_col=0, parse_dates=True).tail(43800)
    bc_sim_h2=pd.read_csv(cl_sim_h2_file, index_col=0, parse_dates=True).tail(43800)
    bc_sim_h3=pd.read_csv(cl_sim_h3_file, index_col=0, parse_dates=True).tail(43800)
    bc_sim_h4=pd.read_csv(cl_sim_h4_file, index_col=0, parse_dates=True).tail(43800)
    bc_sim_h5=pd.read_csv(cl_sim_h5_file, index_col=0, parse_dates=True).tail(43800)
...
if modeplt==6:
    ...
    sys_iso_h_file=os.path.join(script_dir,'data/Wind/benchmark/BC_1/h_sin_iso.csv')
    sys_sim_h1_file=os.path.join(script_dir,'data/Wind/benchmark/NBC/h_sin_sim.csv')
    sys_sim_h2_file=os.path.join(script_dir,'data/Wind/benchmark/BC_1/h_sin_sim.csv')
    sys_sim_h3_file=os.path.join(script_dir,'data/Wind/benchmark/BC_30_C/h_sin_sim.csv')
    sys_sim_h4_file=os.path.join(script_dir,'data/Wind/benchmark/BC_10_C/h_sin_sim.csv')
    sys_sim_h5_file=os.path.join(script_dir,'data/Wind/benchmark/BC_5_C/h_sin_sim.csv')
