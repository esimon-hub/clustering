...
import os
import numpy as np
from wind_stat_config import yr_beg, yr_end
from wind_stat_config import in_cf_act, in_asset, in_folder_cf_model, in_cap_model
from wind_stat_config import out_cl_iso_h, out_cl_sim_h, out_sin_iso_h, out_sin_sim_h
from wind_stat_config import out_cl_iso_d, out_cl_sim_d, out_sin_iso_d, out_sin_sim_d
from wind_stat_config import out_cl_iso_m, out_cl_sim_m, out_sin_iso_m, out_sin_sim_m
